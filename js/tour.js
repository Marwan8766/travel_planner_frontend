...
$(document).ready(function () {
	...
	$(".add-new").click(function(){
		...
		'<td data="price"><input type="text" class="form-control" name="price" id="price"></td>' +
		...
		`<td data="startLocations">
            ...
            // '<td><input type="text" class="form-control" name="phone" id="image"></td>' +
	...
	async function addTour(data, objAvaliable) {
		try {
			...
			if (result.status == 'success') {
				addAvaliable(objAvaliable, result.data.data._id)
			}
		} catch (error) {
