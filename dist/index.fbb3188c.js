...
(function($) {
    ...
    $(document).ready(function() {
        function toggleNavbarMethod() {
            if ($(window).width() > 992) $(".navbar .dropdown").on("mouseover", function() {
    ...
    $("#signup").click(async function(e) {
        ...
        if (regularExpression.test(passwordInput.value)) {
            if (passwordInput.value != passwordConfirmInput.value) $("#alertMessage").removeClass("d-none");
            else $("#alertMessage").addClass("d-none");
            $("#alertpassword").addClass("d-none");
        } else $("#alertpassword").removeClass("d-none");
        if (nameInput.value == "") $("#alertname").removeClass("d-none");
        else $("#alertname").addClass("d-none");
        if (emailInput.value == "") $("#alertemail").removeClass("d-none");
        else $("#alertemail").addClass("d-none");
        // Login
        // waiting backend Api
        if (regularExpression.test(passwordInput.value) && nameInput.value != "" && emailInput.value != "") {
            ...
            } else $("#messageApiFail").addClass("d-none");
        }
    });
    $("#login").click(async function(e) {
        e.preventDefault();
        var regularExpression = /^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$/;
        if (regularExpression.test(passwordInput.value)) $("#alertpassword").addClass("d-none");
        else $("#alertpassword").removeClass("d-none");
        if (emailInput.value == "") $("#alertemail").removeClass("d-none");
        else $("#alertemail").addClass("d-none");
        // Login
...
},{}]},["lWQBG","bDbGG"], "bDbGG", "parcelRequire6b74")
