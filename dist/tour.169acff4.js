...
})({"a1wev":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "07c52404169acff4";
"use strict";
...
},{}],"2bd19":[function(require,module,exports) {
...
$(document).ready(function() {
    ...
    async function getAllTour() {
        ...
        console.log(result);
        TourList = result.data.data.slice(0, 20);
    ...
    $(".add-new").click(function() {
        ...
        `<td data="startLocations">
			...
			</td>` + "<td>" + actions + "</td>" + // '<td><input type="text" class="form-control" name="phone" id="image"></td>' +
        // '<td><input type="text" class="form-control" name="name" id="StartLocations"></td>' +
        // '<td><input type="text" class="form-control" name="department" id="Locations"></td>' +
        // '<td><input type="text" class="form-control" name="phone" id="Company"></td>' +
        // '<td>' + actions + '</td>' +
        "</tr>";
        $("table").prepend(row);
    ...
    async function addTour(data, objAvaliable) {
        try {
            ...
            if (result.status == "success") addAvaliable(objAvaliable, result.data.data._id);
        } catch (error) {
    ...
    async function EditTour(data, id) {
        try {
            const response = await fetch(`${baseUrl}/api/v1/tours/${id}`, {
                method: "PATCH",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("Token")}`
...
},{}]},["a1wev","2bd19"], "2bd19", "parcelRequire6b74")

//# sourceMappingURL=tour.169acff4.js.map
